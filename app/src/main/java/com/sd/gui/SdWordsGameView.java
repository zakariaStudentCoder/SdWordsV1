 ...
 */
public class SdWordsGameView extends View {
    ...
    private WordNumberTranslator translator;
    ...
    public SdWordsGameView(Context context) {
        this(context , null);

    }

    public SdWordsGameView(Context context, AttributeSet attrs/*, int defStyle*/) {
        ...
        //mCells = CellCollection.createDebugGame();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCellNotePaint.setTextSize(mCellHeight / 3.5f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.d("onDraw", "Call");
        Log.d("onDraw" , mHighlightWrongVals + "");
        // some notes:
            ...
            for (int row = 0; row < 9; row++) {
                for (int col = 0; col < 9; col++) {
                    ...
                    if (value != 0) {
                        ...
                        canvas.drawText(
                                (mTranslator != null) ? mTranslator.getTranslateNumberFromWord(value) : Integer.toString(value),
                        ...
                        if (!cell.getNote().isEmpty()) {
                            ...
                            for (Integer number : numbers) {
                                ...
                                canvas.drawText((mTranslator != null) ? mTranslator.getTranslateNumberFromWord(number) : Integer.toString(number)
                                               , cellLeft + c * noteWidth + 2, cellTop + mNoteTop - noteAscent + r * noteWidth - 1, mCellNotePaint);
                            }
                        }
                    }
        ...
        if (!mReadonly) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    activityInstance.BindCellToNotes();
    ...
    public void setHighlightWrongVals()
    {
        Log.d("onDraw" , "setHighlightWrongVals");
        mHighlightWrongVals = true;
    ...
    public void setGame(SudokuGame game, WordNumberTranslator translator, SdWordPlayActivity activity) {
        mGame = game;
    ...
    public void setCells(CellCollection cells) {
        ...
        if (mCells != null) {
            ...
            mCells.addOnChangeListener(new CellCollection.OnChangeListener() {
                @Override
